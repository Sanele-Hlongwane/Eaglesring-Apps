        ...
        <div className="flex flex-col gap-8 md:flex-row">
          <div className="md:w-1/2 mb-6">
            ...
            <p className="text-lg mb-4">
              Our vision is to empower entrepreneurs and investors to reach their
              full potential by offering a robust and user-friendly
          ...
          <div className="md:w-1/2 mb-6">
            ...
            <p className="text-lg mb-4">
              ...
              ideas and for investors to evaluate opportunities. 
              Our platform supports detailed profiles, secure transactions, and 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="border rounded-lg p-6">
            ...
            <p className="text-lg mb-4">
              ...
              innovation. He leads the team with a focus on creating a cutting-edge platform for the investment community.
            </p>
            <a
          ...
          <div className="border rounded-lg  p-6">
            ...
            <p className="text-lg mb-4">
              ...
              oversees the platform&apos;s technical aspects, ensuring a seamless and secure experience for all users.
            </p>
            <a
