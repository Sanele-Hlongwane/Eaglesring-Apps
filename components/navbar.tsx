      ...
      case "INVESTOR":
        return (
          <>
            ...
            <NavbarMenuItem>
              <Link
                className={getLinkClasses("/investor-investments")}
                href="/investor-investments"
                onClick={() => handleLinkClick("/investor-investments")}
              >
                Investments
              </Link>
            </NavbarMenuItem>
            ...
            <NavbarMenuItem>
              <Link
                ...
                href="/connections"
                onClick={() => handleLinkClick("/connections")}
              >
                Connections
              </Link>
            </NavbarMenuItem>
      ...
      case "ENTREPRENEUR":
        return (
          <>
            ...
            <NavbarMenuItem>
              <Link
                className={getLinkClasses("/entr-investments")}
                href="/entr-investments"
                onClick={() => handleLinkClick("/entr-investments")}
              >
                Investments
              </Link>
            </NavbarMenuItem>
            <NavbarMenuItem>
              <Link
                className={getLinkClasses("/pitches")}
                href="/pitches"
                onClick={() => handleLinkClick("/pitches")}
              >
                Pitches
              </Link>
            </NavbarMenuItem>
    ...
    >
      <NavbarContent className="basis-1/5 sm:basis-full" justify="start">
        ...
        <ul className="hidden lg:flex gap-2 justify-start ml-2">
          <SignedIn>{roleBasedOptions(role)}</SignedIn>
          <SignedOut>{commonLinks}</SignedOut>
        </ul>
      </NavbarContent>
