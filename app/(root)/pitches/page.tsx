...
export default function PitchesPage() {
  ...
  const [newPitch, setNewPitch] = useState<
    Omit<Pitch, "id" | "createdAt"> & { videoFile?: File; pitchDeckFile?: File }
  >({
    title: "",
    description: "",
            ...
            <div className="p-6 rounded-lg">
              ...
              <ul className="space-y-4">
                {pitches.length > 0 ? (
                                  ...
                                  {pitch.videoUrl ? (
                                    <div className="mt-2">
                                      ...
                                      <p className="text-gray-500 dark:text-gray-400 mt-2">
                                        You cannot edit the video. To change it,
                                        delete the pitch and create a new one.
                                      </p>
                                    </div>
                                  ) : (
                                ...
                                <div>
                                  ...
                                  pitch.attachments.length > 0 ? (
                                    <div className="mt-2">
                                      ...
                                      <p className="text-gray-500 dark:text-gray-400 mt-2">
                                        You cannot edit the attachments. To
                                        change them, delete the pitch and create
                                        a new one.
                                      </p>
                                    </div>
                                  ) : (
                  ...
                  <div>
                    <p className="text-red-600 bold dark:text-red-500">
                      No pitches found
                    </p>
            ...
            <div className="elative min-h-screen bg-gradient-to-br from-gray-100 to-blue-100 dark:from-gray-900 dark:to-blue-900 text-gray-900 dark:text-white">
              ...
              >
                <div>
                  <label
                    htmlFor="title"
                    className="relative z-10 block text-gray-700 dark:text-gray-200"
                  >
                    Title
                  </label>
                  <input
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setNewPitch({ ...newPitch, description: e.target.value })
                    }
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setNewPitch({
                          ...newPitch,
                          fundingGoal: parseFloat(e.target.value) || 0,
                        })
                      }
                ...
                <div>
                  <label
                    ...
                    className="block text-gray-700 dark:text-gray-200"
                  >
                    Attachments (Files must be 50MB or less)
                  </label>
                  <input
                    type="file"
                    id="attachments"
                    ...
                    onChange={(e) => {
                      ...
                      if (invalidFiles.length > 0) {
                        alert(
                          `Some files are too large. Please ensure each file is 50MB or less.`,
                        );
                      }
