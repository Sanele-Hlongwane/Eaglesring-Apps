...
import { fetchChats, fetchConversations, fetchFriends, sendMessage, fetchConversationMessages } from "@/lib/messageService"; // Adjusted imports
...
const MessagesPage = () => {
  ...
  const fetchMessages = async (id: number) => {
    try {
      const messagesData: Message[] = await fetchConversationMessages(id);
      setActiveChat((prevChat) => (prevChat ? { ...prevChat, messages: messagesData } : null));
    } catch (error) {
            ...
            <>
              ...
              <div className="p-4 border-t border-gray-300 dark:border-gray-700 flex items-center">
                <input
                  ...
                  className="flex-1 border rounded-lg p-2 dark:bg-gray-700 dark:text-gray-200"
                />
                <button
